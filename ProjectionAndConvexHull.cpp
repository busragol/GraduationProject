...
int main(int argc, char** argv)
{
	...
	*cloud_filtered = *cloud_f;
	...
	clusterFilePath << "C:/Users/Busra/Desktop/cloud_cluster_" << k << ".pcd";
	...
	*/
	...
	for (int a = 0; a < 5; a++) {
		...
		clusterpath << "C:/Users/Busra/Desktop/tolerance_30/cloud_cluster_" << a << ".pcd";
		...
		std::stringstream ss;
		ss << "C:/Users/Busra/Desktop/BoundingBox/boundingbox" << a << ".pcd";
	...
	std::ofstream myfile;
	myfile.open("C:/Users/Busra/Desktop/BoundingBox/myboundingboxfile.txt");

	for (int j = 0; j < 5; j++) {
		std::stringstream path;
		path << "C:/Users/Busra/Desktop/BoundingBox/boundingbox" << j << ".pcd";
